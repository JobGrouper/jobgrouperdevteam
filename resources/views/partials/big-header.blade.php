            ...
            <div class="col-md-12">
                ...
                @if (Auth::guest())
                    ...
                    <div class="main_header__buttons">
                        ...
                        <a href="#" onclick="alert('Apologies, we\'re still working on Twitter registration')"><button class="email"><i class="fa fa-twitter" aria-hidden="true"></i>Sign up with <span>Twitter</span></button></a>
