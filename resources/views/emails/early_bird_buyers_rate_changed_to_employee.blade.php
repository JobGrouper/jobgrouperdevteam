...
<p>The rate your early buyers have been paying since your first monthly purchase of 
{{ $data['job']->title }} has now been changed to ${{ number_format($data['job']->early_bird_markup, 2) }}/month.</p>
